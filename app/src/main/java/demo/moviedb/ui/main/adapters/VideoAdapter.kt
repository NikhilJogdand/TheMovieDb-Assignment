...
import demo.moviedb.ui.main.viewholders.VideoViewHolder
import demo.moviedb.utils.Helpers.buildYouTubeThumbnailURL

class VideoAdapter(
    private var movieVideoList: List<MovieVideo>,
