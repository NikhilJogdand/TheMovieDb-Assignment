...
import demo.moviedb.ui.main.adapters.VideoAdapter
import demo.moviedb.ui.main.viewmodels.MovieDetailsViewModel
import demo.moviedb.utils.DateUtils
import demo.moviedb.utils.Helpers
import demo.moviedb.utils.Helpers.buildBackdropImageUrl
import demo.moviedb.utils.Helpers.buildImageUrl
import demo.moviedb.utils.Helpers.setUpTransparentStatusBar
...
class DetailActivity : AppCompatActivity(), OnVideoClickListener,
    ...
    private fun fetchMovieDetails() {
        detailsViewModel.getDetails(movieId = movie.id.toString())
            .observe(this, object : LiveData<MovieDetail>(),
                ...
                override fun onChanged(t: MovieDetail?) {
                    ...
                    if (videoResult.videos!!.isEmpty()) {
                        ...
                        trailerAdapter.notifyItemRangeInserted(
                            trailerData.size - videoResult.videos!!.size,
                            videoResult.videos!!.size
                        )
                        trailerProgressBar.visibility = View.GONE
                    }
