...
fun getSearchMovies(
    ...
    service.tmdbApi.getSearchMovies(
        TMDB_API_KEY, "en-US",
...
fun getPopularMovies(
    ...
    service.tmdbApi.getPopularMovies(
...
fun getNowShowingMovies(
    ...
    service.tmdbApi.getNowShowingMovies(
        TMDB_API_KEY, language,
        page, region, "2|3"
    ).enqueue(
        object : Callback<MovieRequest> {
