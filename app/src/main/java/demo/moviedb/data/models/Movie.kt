...
/**
 * Our Movie Model is the crust of this application. Exposing our model to the observable
 */
...
class Movie() : Parcelable {
    ...
    constructor(
        voteCount: Int?, id: Int?, video: Boolean?,
        ...
        genreString: String, contentType: Int
    ) : this() {
